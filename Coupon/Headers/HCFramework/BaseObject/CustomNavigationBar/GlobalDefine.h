...
#define SCREENSize  [UIScreen mainScreen].bounds.size.width/320

#define TabBarHeight                        SCREENSize*49.0f
#define NaviBarHeight                       SCREENSize*44.0f
#define BaseViewHeight                      [UIScreen mainScreen].bounds.size.height -SCREENSize*49.0f - SCREENSize*44.0f
